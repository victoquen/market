...
if ($accion != "baja") {
    ...
    $fecha_caducidad = explota($_POST["fechacaducidad"]);
}

if ($accion == "alta") {
    $proveedor = new proveedor();
    $idproveedor = $proveedor->save_proveedor($conn, $ci_ruc, $empresa, $representante, $email, $web, $direccion, $lugar,$autorizacion,$fecha_caducidad);
...
if ($accion == "modificar") {
    ...
    $proveedor = new proveedor();
    $result = $proveedor->update_proveedor($conn, $idproveedor, $ci_ruc, $empresa, $representante, $email, $web, $direccion, $lugar, $autorizacion, $fecha_caducidad);
            ...
            <div id="frmBusqueda">
                ...
                <table class="fuente8" width="50%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
                    ...
                    while ($contador < $num_rows_fono) {
                        ...
                        <tr>
                            <td width="15%"
                                align="center"><?php echo mysql_result($rs_fono, $contador, 'numero') ?></td>
                            <td width="15%" align="center"><?php echo mysql_result($rs_operadora, 0, 'nombre') ?></td>
                            <td width="20%"
                                align="center"><?php echo mysql_result($rs_fono, $contador, 'descripcion') ?></td>
                        </tr>
                        <?php
                        $contador++;
                    }
                ...
                <table class="fuente8" width="70%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
                    ...
                    while ($contador < $num_rows_banco) {
                        ...
                        <tr>
                            ...
                            <td width="28%"
                                align="center"><?php echo mysql_result($rs_banco, $contador, 'titular') ?></td>
                            <td width="14%"
                                align="center"><?php echo mysql_result($rs_banco, $contador, 'numero_cuenta') ?></td>
                ...
                if (mysql_num_rows($rs_contacto) > 0) {
                    ...
                    <table class="fuente8" width="70%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
                        ...
                        while ($contador < $num_rows_contacto) {
                            ...
                            <tr>
                                <td width="14%"
                                    align="center"><?php echo mysql_result($rs_contacto, $contador, 'cargo') ?></td>
                                <td width="30%"
                                    align="center"><?php echo mysql_result($rs_contacto, $contador, 'nombre') ?></td>
                                <td width="13%"
                                    align="center"><?php echo mysql_result($rs_contacto, $contador, 'linea') ?></td>
                                <td width="13%"
                                    align="center"><?php echo mysql_result($rs_contacto, $contador, 'email') ?></td>
                            </tr>
                            <tr>
            ...
            <div id="botonBusqueda">
                <?php if ($origen == "factura") { ?>
                    <img src="../img/botonaceptar.jpg" width="85" height="22"
                         onClick="ingreso_factura(<?php echo $validacion ?>,'<?php echo $idproveedor ?>','<?php echo $empresa ?>','<?php echo $ci_ruc ?>')"
