...
<div id="pagina">
    <div id="zonaContenido">
        <div align="center">
            <div id="tituloForm" class="header">INSERTAR PORCENTAJE TARJETA CREDITO</div>
            <div id="frmBusqueda">
                <form id="formulario" name="formulario" method="post" action="save.php">
                    <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                        <tr>
                            <td width="15%">% TARJETA CREDITO</td>
                            <td width="43%"><input NAME="Rporcentaje" type="text" id="porcentaje" size="45" maxlength="45"
                                                   class="cajaGrande"></td>
