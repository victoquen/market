            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                ...
                <tr>
                    <?php if ($fechainicio != $fechafin) { ?>
                        <th colspan="5"><span style="font-size: 12px">PERIODO DESDE: <?php echo implota($fechainicio) ?>
                                ----- HASTA: <?php echo implota($fechafin) ?></span></th>
                        <th colspan="4"><span
                                style="font-size: 12px">TOTAL RETENCIONES: $ <?php echo $total_retenciones ?></span>
                        </th>
                    <?php } else { ?>
                        <th colspan="5"><span style="font-size: 12px">FECHA: <?php echo implota($fechafin) ?></span>
                        </th>
                        <th colspan="4"><span
                                style="font-size: 12px">TOTAL RETENCIONES: $ <?php echo $total_retenciones ?></span>
                        </th>
