            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                ...
                <tr>
                    <?php if ($fechainicio != $fechafin) { ?>
                        <th colspan="11"><span
                                style="font-size: 12px">PERIODO DESDE: <?php echo implota($fechainicio) ?>
                                ----- HASTA: <?php echo implota($fechafin) ?></span></th>

                    <?php } else { ?>
                        <th colspan="7"><span style="font-size: 12px">FECHA: <?php echo implota($fechafin) ?></span>
                        </th>
                        <th colspan="4"><span
                                style="font-size: 12px">TOTAL RETENCIONES: $ <?php echo $total_retenciones ?></span>
                        </th>
                    <?php } ?>
                </tr>
                <tr>
                    ...
                    <th width="25%"><span style="font-size: 10px">Proveedor</span></th>
