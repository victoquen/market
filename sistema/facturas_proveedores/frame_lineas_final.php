...
if ($modif <> 1) {
    ...
    if ($retorno == 0) {
        ...
        $sel_articulos = "UPDATE producto SET stock='$totstock', pvp='$pvp' , pvp2='$pvpb' , pvp3='$pvpc' , pvp4='$pvpd' , costo='$precio', utilidad = '$utilidad' WHERE id_producto='$idarticulo'";
...
<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
    ...
    for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) {
        ...
        <tr class="<?php echo $fondolinea ?>">
            ...
            <td width="3%"><a
                    href="javascript:eliminar_linea(<?php echo $idfactura ?>,<?php echo $id_factulineap ?>,<?php echo $subtotal ?>,<?php echo $iva ?>,<?php echo $descuento ?>, <?php echo $idbodega ?>)"><img
                        src="../img/eliminar.png" border="0"></a></td>
            <td width="3%"><a
                    href="javascript:modificar_linea(<?php echo $idfactura ?>,<?php echo $id_factulineap ?>,<?php echo $subtotal ?>,<?php echo $iva ?>,<?php echo $descuento ?>, <?php echo $utilidad ?>, <?php echo $idbodega ?>)"><img
