...
<div id="pagina">
    <div id="zonaContenido">
        <div align="center">
                    ...
                    <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                        <tr>
                            ...
                            <td colspan="2">
                                <input NAME="autorizacion" type="text" class="cajaPequena" id="autorizacion"
                                       maxlength="12" value="<?php echo $autorizacion ?>">
                                <input type="text" name="fecha_caducidad" id="fecha_caducidad" class="cajaPequena"
                                       value="<?php echo implota(mysql_result($rs_proveedor, 0, "fecha_caducidad")); ?>"
                                       readonly>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="35%"><input NAME="nombre" type="text" class="cajaGrande" id="nombre" size="45"
                                                   ...
                                                   value="<?php echo mysql_result($rs_proveedor, 0, "empresa"); ?>">
                            ...
                            <td colspan="2"><input NAME="ci_ruc" type="text" class="cajaMedia" id="ci_ruc" size="20"
                                                   ...
                                                   value="<?php echo mysql_result($rs_proveedor, 0, "ci_ruc"); ?>"></td>
                        ...
                        <tr>
                            ...
                            <td><input NAME="codproveedor" type="text" class="cajaPequena" id="codproveedor" size="6"
                                       ...
                                       value="<?php echo mysql_result($rs_proveedor, 0, "id_proveedor"); ?>"></td>
                        ...
                        <tr>
                            <td width="6%">Fecha</td>
                            <td width="27%">
                                <input type="text" id="fecha" name="fecha" value="<?php echo implota($fecha) ?>"
                                       readonly>
                            </td>
            ...
            <br>
            <div id="frmBusqueda">
                <form id="formulario_lineas" name="formulario_lineas" method="post" action="frame_lineas_final.php"
                      target="frame_lineas">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cantidad: <input
                                    ...
                                    maxlength="10" value="1" onChange="actualizar_importe()"></td>
                            <td>
            ...
            <div id="frmBusqueda">
                <table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
                        ...
                        <td width="73%" align="right">
                            <div align="center">
                                <input class="cajaTotales" name="baseimponible" type="text" id="baseimponible" size="12"
                                       align="right" readonly value="<?php echo $baseimponible ?>">
                                &#36;</div>
                        </td>
                    </tr>
                        ...
                        <td width="73%" align="right">
                            <div align="center">
                                <input class="cajaTotales" name="descuentototal" type="text" id="descuentototal"
                                       size="12" align="right" onchange="restar_descuento()"
                    ...
                    <tr>
                        ...
                        <td width="73%" align="right">
                            <div align="center">
                                <input class="cajaTotales" name="iva0" type="text" id="iva0" size="12" align="right"
                                       readonly value="<?php echo $iva0 ?>">
                                &#36;</div>
                        </td>
                    </tr>
                        ...
                        <td width="73%" align="right">
                            <div align="center">
                                <input class="cajaTotales" name="importeiva" type="text" id="importeiva" size="12"
                                       align="right" readonly value="<?php echo $importeiva ?>">
                                &#36;</div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="73%" align="right">
                            <div align="center">
                                <input class="cajaTotales" name="flete" type="text" id="flete" size="12" align="right"
                                       onchange="sumar_flete()" value="<?php echo $flete ?>">
                                &#36;</div>
                        </td>
                    </tr>
                        ...
                        <td align="right">
                            <div align="center">
                                <input class="cajaTotales" name="preciototal" type="text" id="preciototal" size="12"
                                       align="right" readonly value="<?php echo $totalfactura ?>">
                                &#36;</div>
                        </td>
                    </tr>
                </table>
                    ...
                    <td>
                        <div id="botonBusqueda">
                            <div align="center">
                                ...
                                <input id="preciototal2" name="preciototal2" value="<?php echo $totalfactura ?>"
                                       type="hidden">
                            </div>
                        </div>
                    </td>
