...
<script language="javascript">
    ...
    function pon_prefijo(codarticulo, nombre, idarticulo, iva, pvp , pvp2, pvp3,pvp4, costo) {
        ...
        parent.opener.document.formulario_lineas.pvpb.value = pvp2;
        parent.opener.document.formulario_lineas.pvpc.value = pvp3;
        parent.opener.document.formulario_lineas.pvpd.value = pvp4;
