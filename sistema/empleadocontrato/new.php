                            ...
                            <td width="43%">
                                <select id="Acboempleado" class="comboMedio" NAME="Acboempleado">
                                    ...
                                    while ($contador < mysql_num_rows($res_o)) {
                                        ?>
                                        <option
                                            value="<?php echo mysql_result($res_o, $contador, "id") ?>"><?php echo mysql_result($res_o, $contador, "emple") ?></option>
                                        <?php $contador++;
                                    } ?>
                                </select>
                            ...
                            <td>
                                <select id="Acbocontrato" class="comboMedio" NAME="Acbocontrato">
                                    ...
                                    while ($contador1 < mysql_num_rows($res_a)) {
                                        ?>
                                        <option
                                            value="<?php echo mysql_result($res_a, $contador1, "id") ?>"><?php echo mysql_result($res_a, $contador1, "nombre") ?></option>
                                        <?php $contador1++;
                                    } ?>
                                </select>
                            </td>
