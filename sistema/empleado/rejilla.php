...
<html>
	<head>
       ...
       <!-- FIN archivos para DATA TABLES-->
		...
		function ver(idempleado) {
			parent.location.href="ver.php?idempleado=" + idempleado;
		}
		
		function modificar(idempleado) {
                    
			parent.location.href="modificar.php?idempleado=" + idempleado;
		}
		
		function eliminar(idempleado) {
                    if (confirm("Atencion va a proceder a la baja de una entidad bancaria. Desea continuar?")) {
			parent.location.href="eliminar.php?idempleado=" + idempleado;
                    }
		}
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th ><span style="font-size: 10px">CEDULA</span></th>
