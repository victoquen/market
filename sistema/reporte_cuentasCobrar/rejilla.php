...
<html>
<head>
    <title>CUENTAS x COBRAR CLIENTES</title>
    ...
    <script language="javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#example').dataTable({
                ...
                "sAjaxSource": "processing_cuentasCobrar.php?fecha_inicio=<?php echo $fechainicio?>&fecha_fin=<?php echo $fechafin?>&tipoCliente=<?php echo $tipoCliente?>",
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                ...
                <tr>
                    <?php if ($fechainicio != $fechafin) { ?>
                        <th colspan="3"><span style="font-size: 12px">PERIODO DESDE: <?php echo implota($fechainicio) ?>
                                ----- HASTA: <?php echo implota($fechafin) ?></span></th>
                        <th colspan="6"><span
                                style="font-size: 12px">TOTAL FACTURAS: $ <?php echo $total_facturas ?></span></th>
                    <?php } else { ?>
                        <th colspan="3"><span style="font-size: 12px">FECHA: <?php echo implota($fechafin) ?></span>
                        </th>
                        <th colspan="7"><span
                                style="font-size: 12px">TOTAL $ FACTURAS: $ <?php echo $total_facturas ?></span></th>
                    <?php } ?>
